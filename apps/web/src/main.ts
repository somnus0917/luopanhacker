...
type OperationRecord = AnyRecord & {
  date: string;
  shop_name: string;
  source?: string;
  source_label?: string;
...
function bindLineChartHover(records: OperationRecord[]) {
